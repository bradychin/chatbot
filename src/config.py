...
#--------- main.py ---------#
model_path = os.path.join(os.path.dirname(__file__), '../models/checkpoints/checkpoint_epoch_0_batch_2000')

#--------- model_trainer.py ---------#
dataset_file_path = os.path.join(os.path.dirname(__file__), '../data/personachat.csv')
